...
running command...
$ barscrap (--version)
barscrap/0.5.0 linux-x64 node-v18.15.0
...
_See code: [dist/commands/scrape/index.ts](https://github.com/cmo7/barscrap/blob/v0.5.0/dist/commands/scrape/index.ts)_
<!-- commandsstop -->
